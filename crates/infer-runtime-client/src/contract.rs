...
pub(crate) fn expected_capability_schema(identity: &str) -> Option<(&'static str, &'static str)> {
    Some(match identity {
        "infer.vision.apple-native@20260926.2" => (
            "/infer/v1/capability-schemas/infer.vision.apple-native/20260926.2/openapi.json",
        ...
        "infer.audio.transcription@20260814.1" => (
            "/infer/v1/capability-schemas/infer.audio.transcription/20260814.1/openapi.json",
        ...
        "infer.audio.sound-generation@20260926.2" => (
            "/infer/v1/capability-schemas/infer.audio.sound-generation/20260926.2/openapi.json",
...
mod tests {
    ...
    fn sound_generation_schema_is_pinned_to_discovery_bytes() {
        ...
        let bytes = include_bytes!(
            "../../../contracts/capabilities/infer.audio.sound-generation/20260926.2/openapi.json"
        );
        assert_eq!(format!("{:x}", Sha256::digest(bytes)), digest);
    }
